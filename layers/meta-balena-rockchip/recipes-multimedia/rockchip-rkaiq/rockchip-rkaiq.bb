...
#     predates the balenaOS SCHED fallback (cd14f98) and the sensor-less
#     seat guards (f1e620a); on balenaOS its engine logs "stats disorder"
...
# on balenaOS), d9d2f21 (imx708 IQ), 07bebb0 (unit stop cap) and the
